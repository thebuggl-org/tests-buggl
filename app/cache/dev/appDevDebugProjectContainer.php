...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/beta-buggl/app/cache/dev/annotations', true);
    }
    ...
    /**
     * Gets the 'buggl.twig.extension.debug' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getBuggl_Twig_Extension_DebugService()
    {
        return $this->services['buggl.twig.extension.debug'] = new \Twig_Extensions_Extension_Debug();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager566ea615f10eb_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager566ea615f10eb_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'C:/xampp/htdocs/beta-buggl/app/cache/dev/jms_diextra/doctrine/EntityManager_566ea615f10eb.php';

        $a = $this->get('annotation_reader');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_f195037c6ab59408c282cf54b3bfc9b6');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f195037c6ab59408c282cf54b3bfc9b6');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_f195037c6ab59408c282cf54b3bfc9b6');
        ...
        $g->setProxyDir('C:/xampp/htdocs/beta-buggl/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager566ea615f10eb_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($h, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/xampp/htdocs/beta-buggl/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/beta-buggl/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/beta-buggl/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/xampp/htdocs/beta-buggl/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/xampp/htdocs/beta-buggl/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.main'), 1 => $this->get('security.user.provider.concrete.admin')), 'secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'secured_area', $e, $e, array('check_path' => '/login_check', 'use_forward' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '566ea615b57bd', $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $d, '/login', true), NULL, NULL, $b));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/beta-buggl/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/beta-buggl/app/cache/dev/sessions');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('buggl.twig.extension.debug'));
     ...
     *
     * @return EntityManager566ea615f10eb_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/beta-buggl/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Extra_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/xampp/htdocs/beta-buggl/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/beta-buggl/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/beta-buggl/app/cache/dev',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/beta-buggl/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/beta-buggl/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/beta-buggl/app/cache/dev/assetic/routing.yml',
            ...
            'swiftmailer.spool.memory.path' => 'C:/xampp/htdocs/beta-buggl/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/beta-buggl/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/beta-buggl/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'C:/xampp/htdocs/beta-buggl/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'C:/xampp/htdocs/beta-buggl/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/xampp/htdocs/beta-buggl/app/cache/dev/jms_diextra/doctrine/EntityManager_566ea615f10eb.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager566ea615f10eb_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'C:/xampp/htdocs/beta-buggl/app/cache/dev/jms_security',
