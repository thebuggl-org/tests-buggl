 	...
 	function guideInfo()
 	{
 		...
 		var prepareCountry = function(){
		    ...
		    $( "#country-search" ).autocomplete({
				...
				search: function(event, ui){
					$( "#country-search" ).data('id', 0);
				},
				select: function(event, ui){
					// console.log(ui);
					if(ui.item.id == 0){
						$( "#country-search" ).val("");
						$( "#country-search" ).data('id', ui.item.id);
						return false;
					}
 		...
 		*/
 		...
 		var prepareAddLocation = function(){
 			...
 			$(".add-city", form)
 			.on('click', function(){
 				// console.log($("#google-place-search").val());
 				var location = $("#google-place-search").val();
