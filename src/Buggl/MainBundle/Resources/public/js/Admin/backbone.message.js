(function($){
    $.message = function(options){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(data.success){
                            ...
                            console.log(self.eventListener);
                        }
                    }
                })
            }
        ...
        MessagesView = Backbone.View.extend({
            el: $('div#main_content'),
            initialize: function(){
                _.bindAll(this,'render','renderMessage','search','changeTotalCount');
